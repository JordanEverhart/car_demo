...
parser.add_argument("--checkpoint", type=str, default='logs/sb3/Isaac-NovaFrankaNav-v2/2025-04-11_21-51-01/model_128000000_steps.zip', help="Path to model checkpoint.")
parser.add_argument(
